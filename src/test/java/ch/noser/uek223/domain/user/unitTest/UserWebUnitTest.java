...
class UserWebUnitTest {
    ...
    void findAll_requestAllUsers_returnsAllUsers() throws Exception {
        User user1 = new User().setId(UUID.randomUUID()).setEmail("cs@mail.com").setPassword("").setFirstName("Chris").setLastName("South").setRoles(Set.of(new Role().setName("ADMIN").setAuthorities(Set.of(new Authority().setName("CAN_RETRIEVE_ALL_PRODUCTS")))));
        User user2 = new User().setId(UUID.randomUUID()).setEmail("aa@mail.com").setPassword("").setFirstName("Anna").setLastName("Abby").setRoles(Set.of(new Role().setName("CUSTOMER").setAuthorities(Set.of(new Authority().setName("CAN_DELETE_USER")))));
